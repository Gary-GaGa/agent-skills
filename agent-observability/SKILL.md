...
related: [agent-harness-design, agent-evaluation, debugging-methodology]
---
...
- [`debugging-methodology`](../debugging-methodology/SKILL.md) — same principles, agent-specific application
