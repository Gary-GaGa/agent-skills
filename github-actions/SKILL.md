...
related: [docker-basics, git-workflow, go-testing]
---
...
- [`git-workflow`](../git-workflow/SKILL.md) — PR workflow that CI validates
- [`go-testing`](../go-testing/SKILL.md) — tests the pipeline runs
